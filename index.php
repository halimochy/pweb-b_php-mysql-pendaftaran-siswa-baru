...
<head>
    ...
    <title>Pendaftaran Siswa Baru | SMK CodDev </title>
...
<body class="fixed">
	...
	<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
        <div class="container" id="navbar-content">
            <a class="navbar-brand" href="index.php" id="logo">SMK CodDev</a>
            ...
            <div class="row">
                <div class="col-12" id="hero-content">
                    <h1 class="fw-semibold mt-0 mb-4" id="title">Pendaftaran Siswa Baru</h1>
                        ...
                        <?php endif ?>
                    <div>
                        <a href="form-daftar.php" class="btn btn-outline-primary" id="daftar-btn">Daftar Baru</a>
                        <a href="list-siswa.php" class="btn btn-outline-secondary" id="pendaftar-btn">Pendaftar</a>
                    </div>
                </div>
            </div>
        </div>
